...
echo " ***** TESTING structured spew log with kubernetes metadata ****"
curl -v -X POST \
  http://127.0.0.1:3000/ \
  -H 'cache-control: no-cache' \
  -H 'content-type: application/json' \
  -H 'postman-token: a16e943a-11d4-96e5-d538-1665eb121320' \
  -d '[{"date":1524593675.912965, "log":"2017-04-10 14:03:26  INFO worker-3 clj-sequoia.logging - {\"dests\":[\"k8s-pirate-message\"],\"_lb0\":{\"k8s-pirate-message\":\"d130464d-4f32-45c8-8214-60e5e81f78f4\"},\"eventid\":\"1c8ac112-7852-4bd6-b020-9dd6dbe50372\",\"requestid\":\"df20af5d-3efa-4a40-8bae-b1ab0a475d50\",\"origin\":\"local-pirate-spew.test\",\"eventtype\":\"foo\",\"tstamp_usec\":1524593675912539}", "stream":"stdout", "time":"2018-04-24T18:14:35.912964498Z", "dests":["k8s-pirate-message"], "_lb0":{"k8s-pirate-message":"d130464d-4f32-45c8-8214-60e5e81f78f4"}, "eventid":"1c8ac112-7852-4bd6-b020-9dd6dbe50372", "requestid":"df20af5d-3efa-4a40-8bae-b1ab0a475d50", "origin":"local-pirate-spew.test", "eventtype":"foo", "tstamp_usec":1524593675912539, "kubernetes":{"pod_name":"go-spew-bvjsv", "namespace_name":"kangaroo", "pod_id":"e088d28f-44d0-11e8-ab76-1290c35ba306", "labels":{"app":"go-spew", "controller-revision-hash":"2257197465", "logstream":"go-spew", "pod-template-generation":"1"}, "annotations":{"fluentbit.io/parser":"json", "kubernetes.io/created-by":"{\\\"kind\\\":\\\"SerializedReference\\\",\\\"apiVersion\\\":\\\"v1\\\",\\\"reference\\\":{\\\"kind\\\":\\\"DaemonSet\\\",\\\"namespace\\\":\\\"kangaroo\\\",\\\"name\\\":\\\"go-spew\\\",\\\"uid\\\":\\\"e0817306-44d0-11e8-8116-0a6da5621b62\\\",\\\"apiVersion\\\":\\\"extensions\\\",\\\"resourceVersion\\\":\\\"54707473\\\"}}\\n", "kubernetes.io/limit-ranger":"LimitRanger plugin set: cpu, memory request for container go-spew; cpu, memory limit for container go-spew", "logging.parser":"json", "logging.topic":"k8s-watermark"}, "host":"ip-172-28-148-178.ec2.internal", "container_name":"go-spew", "docker_id":"2e9114d7c53f267b348d60e2658359263d5aaea14e829763420282415980cd0d"}}]'
